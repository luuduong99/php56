...
<div class="col-md-12" style="font-size: 16px;">
    <div style="margin-bottom:5px;">
        <a style="font-size: 16px;" href="index.php?controller=users&action=create" class="btn btn-primary">Add user</a>
    </div>
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <ul class="pagination">
                ...
                <li class="page-item"><a href="index.php?controller=users&p=<?php echo $i; ?>" class="page-link"></a></li>
                <?php endfor; ?>
            </ul>
        </div>
    </div>
